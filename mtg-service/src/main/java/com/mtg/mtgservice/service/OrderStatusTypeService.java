...
public class OrderStatusTypeService {
  ...
  public OrderStatusType createOrderStatusType(OrderStatusTypeDto orderStatusTypeDto)
      throws EntityNotFoundException {
    return orderStatusTypeRepository.saveAndFlush(
        orderStatusTypeDtoMapper.toEntity(orderStatusTypeDto));
  }
}
